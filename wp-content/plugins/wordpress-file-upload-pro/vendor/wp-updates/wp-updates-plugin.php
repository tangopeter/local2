...
new WPUpdatesPluginUpdater_1662( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1662') ) {
    class WPUpdatesPluginUpdater_1662 {
